...
public:
	...
	f32 getDeterminant()
	{
		...
		CXVec4 v1 = CXVec4(this->m_mat[0][0], this->m_mat[1][0], this->m_mat[2][0], this->m_mat[3][0]);
		CXVec4 v2 = CXVec4(this->m_mat[0][1], this->m_mat[1][1], this->m_mat[2][1], this->m_mat[3][1]);
		CXVec4 v3 = CXVec4(this->m_mat[0][2], this->m_mat[1][2], this->m_mat[2][2], this->m_mat[3][2]);
