...
VertexBuffer::VertexBuffer(const VertexBufferDesc& desc,
                               GraphicsEngine* system) : m_system(system)
{
	...
	{
		//SEMANTIC NAME - SEMANTIC INDEX - FORMAT - INPUT SLOT - ALIGNED BYTE OFFSET - INPUT SLOT CLASS - INSTANCE ATA STEP RATE
...
ui32 VertexBuffer::getVerticesListSize()
{
	return m_desc.listSize;
}

ui32 VertexBuffer::getVertexSize()
{
